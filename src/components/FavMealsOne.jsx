...
const FavMealsOne = ({ meal, callbackRemoveFavMeal, callbackBuylist }) => {
  ...
  return (
    ...
    >
      ...
      <div className="w-full md:w-[170px] md:bg-lightTextCol rounded-xl absolute top-[69.5%] md:top-[77%] flex flex-start px-[10px] py-3 flex-col gap-y-[2px] md:cardNameShadow z-20">
        <p className={`text-[20px] md:text-[16px] text-lightTextCol md:text-darkTextCol font-semibold whitespace-nowrap truncate`}>
