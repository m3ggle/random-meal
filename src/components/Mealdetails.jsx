...
import { FaTimes, FaShoppingCart, FaShare } from "react-icons/fa";
        ...
        >
          ...
          <div className="w-full modalGradient flex flex-col px-[30px] 900:px-10 pb-20 gap-y-8 900:gap-y-4">
            ...
            <div className="w-full flex flex-col gap-y-2">
              ...
              <p
                className={`${styles.heading32} text-lightTextCol flex flex-row gap-x-2 items-center`}
              >
            ...
            <div className="w-full flex flex-col-reverse 900:flex-row gap-y-8 900:gap-x-10 900:py-4">
              {/* instructions */}
              <div className="w-full flex flex-col gap-y-2">
                ...
                <div className="w-full max-w-[540px] flex flex-col buyinglistMealShadow p-[24px] gap-y-4 rounded-xl">
                  ...
                  <p className={`${styles.paragraph16} text-lightTextCol`}>
                    ...
                    suspendisse convallis eget fringilla euismod. Id arcu, massa
                    lacinia eget id. Augue velit id accumsan massa.
                  </p>
              ...
              <div className="w-full flex flex-col gap-y-2">
                ...
                <div className="max-w-[540px] w-full flex flex-wrap gap-2">
                  <div
                    ...
                    style={{ backgroundImage: `url(${DinnerImg})` }}
                  >
                    <div className="w-full h-full rounded-full bg-gray-400 hidden hover:flex"></div>
                  </div>
                  <div
                    className="w-20 h-20 rounded-full bg-center bg-cover bg-gray-400"
                    style={{ backgroundImage: `url(${DinnerImg})` }}
                  ></div>
                  <div
                    className="w-20 h-20 rounded-full bg-center bg-cover bg-gray-400"
