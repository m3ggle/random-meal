  ...
  const [activeSite] = useState("home");
    ...
    return (
      <div className="w-0px md:w-[80px]">
        {/* desktop Navbar */}
        <div className="hidden md:flex w-[80px] md:fixed md:h-screen  bg-navCol py-[32px] flex-col justify-between">
          {/* navbar top */}
        ...
        {/* mobile Navbar */}
        <div className={`md:hidden fixed bottom-6 w-full ${styles.flexCenter} z-50`}>
          <div className="flex justify-between align-center py-[10px] px-[20px] min-w-[320px] w-9/12 max-w-[450px] rounded-xl bg-bgSecondaryDarkCol">
