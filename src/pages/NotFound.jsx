...
const NotFound = () => {
  return (
    <main className="flex h-screen w-full flex-col items-center justify-center bg-bgPrimaryCol">
      {/* <Helmet>
      ...
      <button className="mt-5">
        ...
        >
          ...
          <span className="relative block border border-current bg-bgPrimaryCol px-8 py-3">
            <div>Go Home</div>
          </span>
        </Link>
      </button>
